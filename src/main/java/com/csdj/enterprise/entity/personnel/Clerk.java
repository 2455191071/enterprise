...
public class Clerk {
    ...
    private int positionId;//主职位
    private String phone;//移动电话
    private String hireDate;//入职日期
    private int status;//供职状态
    private String QQ;//办公QQ
    private String offPhone;//办公电话
    private String wechatId;//微信号
    private String email;//电子邮箱
    private String address;//住址
    private int paymentId;//薪酬编号
    private int socialId;//社保标准编号
    private String account;//工资账户
    private int checkId;//考勤编号
    private String creditLine;//信用额度
    private int loginId;//登录账号
